...
def _apply_env_overrides(config: GatewayConfig) -> None:
    ...
    qqbot_secret = os.getenv("QQBOT_SECRET")
    if qqbot_app_id and qqbot_token and qqbot_secret:
        ...
        config.platforms[Platform.QQBOT].token = qqbot_token
        config.platforms[Platform.QQBOT].extra.update({
            "app_id": qqbot_app_id,
            "token": qqbot_token,
            "secret": qqbot_secret,
        })
        qqbot_ws_url = os.getenv("QQBOT_WEBSOCKET_URL", "")
        if qqbot_ws_url:
            config.platforms[Platform.QQBOT].extra["websocket_url"] = qqbot_ws_url
