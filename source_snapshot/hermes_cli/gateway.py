...
_PLATFORMS = [
    ...
    },
    {
        ...
        "setup_instructions": [
            "1. Go to https://q.qq.com/ (QQ Open Platform) and create an application",
            "2. Enable the Bot capability and obtain App ID, App Token, and App Secret",
            "3. The bot connects via WebSocket — no public endpoint needed",
            "4. Add the bot to a group chat or message it directly in QQ",
            "5. Restrict access with QQBOT_ALLOWED_USERS for production use",
        ],
        "vars": [
            {"name": "QQBOT_APP_ID", "prompt": "App ID", "password": False,
             "help": "The App ID from your QQ Bot application."},
            {"name": "QQBOT_TOKEN", "prompt": "App Token", "password": True,
             "help": "The token from your QQ Bot application."},
            {"name": "QQBOT_SECRET", "prompt": "App Secret", "password": True,
            ...
            {"name": "QQBOT_ALLOWED_USERS", "prompt": "Allowed user IDs (comma-separated, or empty)", "password": False,
             "is_allowlist": True,
             "help": "Restrict which QQ users can interact with the bot."},
            {"name": "QQBOT_HOME_CHANNEL", "prompt": "Home chat ID (optional, for cron/notifications)", "password": False,
             "help": "Chat ID for scheduled results and notifications."},
        ],
    },
]
